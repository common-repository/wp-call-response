<?php
namespace CallResponse\license;
  ...
  return $result;
	...
	function reValidate($type="frontend")
	{
		...
		function revqlidte".$this->plugin."()
		{
			...
			srvr.send('action=cractionresponse_adminajxlcnc&reverifyjkmvhblicense=1&rvryfyplugin=".$this->plugin."&rvryfypluginpref=".$this->prefix."');
		}
...
class gdpractivationpage extends  wpgdprpluginlisence
{
	...
	function loadActivationPage()
	{
		...
		add_menu_page('Call Response','Call Response','administrator','call_response',array($this,$callback),'');
	}
