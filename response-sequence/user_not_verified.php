...
<div class="container-fluid">
    <div class="row"><br>
        ...
        <div class="col-sm-6">
            ...
            <h4 class="text-center m0"> Welcome to WP Call Response</h4></div>
            <div class="panel-body">
            <div class="alert alert-warning">
  <strong>Hi!</strong> Welcome to WP Call Response. You need to verify your purchase to continue. This is a one-time task and will not be repeated on this site.
...
All you need to verify is to put in the email you used to purchase WP Call Response.
            ...
            <div class="account-wall">
                ...
                <a href="http://teknikforce.com" class="text-center new-account" target="_BLANK">Didn't buy WP Call Response yet? Buy it here</a>
